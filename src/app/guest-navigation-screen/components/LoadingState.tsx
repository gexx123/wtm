...
export default function LoadingState() {
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6 font-jakarta overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        {/* Glassmorphism Card */}
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 sm:p-10 rounded-[2.5rem] shadow-glass animate-in-slide-up flex flex-col items-center">
